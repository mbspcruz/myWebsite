...
const projects = [
	{
		...
		paragraph:
			"This website is a template for a portefolio, where you can have a very interactive experience by scrolling. The model was made in Blender, and so was the fish animation. The scroll animations were mainly using the helper library for threejs called GSAP, which enabled us to create this cool and smooth effect with the circles and the zoom in.",
		srclink: "https://abigaill.netlify.app/",
		hublink: "https://github.com/mbspcruz/abigaail",
	},
	{
		id: "messagemail",
		title: "MessageMail",
